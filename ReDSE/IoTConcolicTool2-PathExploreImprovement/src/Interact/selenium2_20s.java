...
public class selenium2_20s {
    ...
    public selenium2_20s(ArrayList<String> preferencesInputs, ArrayList<String> simulatorsInputs, String codePath, String defaultValue) {
